...
{
    /** List (scoped by tenant). Newest at bottom like your other lists. */
    ...
    protected function validated(Request $request): array
    {
        return $request->validate([
            ...
            'certifications'  => ['nullable'],   // JSON string from hidden input
        ]);
    }
    ...
    protected function tenantId(): int
    {
        ...
        if (!isset($user->tenant_id)) abort(500, 'Tenant context not set for this user.');
